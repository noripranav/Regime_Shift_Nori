...
Needs real internet access to Yahoo Finance. Every module also has a
`test_*.py` file that runs fully offline against synthetic data, so you
can verify the logic without network access:
